    ...
    <div class="content-wrapper" style="min-height: 471px;">
        <div class="container">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    <br>
                    <li><a href="/traffic/index"><i class="fa fa-dashboard"></i>交通</a></li>
                    ...
                    <div class="box-tools col-lg-2">
                        <form action="/hotel/hotelPointSearch" method="get">
                            <div class="input-group input-group-sm" style="width: 150px;">
                                ...
                                <input type="text" name="keyword" class="form-control pull-right" placeholder="交通搜索...">
