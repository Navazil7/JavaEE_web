                ...
                <div class="box box-info">
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <br>
                            <h3 class="box-title"> 车站、机场信息新增</h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form class="form-horizontal" action="/admin/stationInsert" method="post">
                            <div class="box-body">

                                <%--tpSname--%>
                                <div class="form-group">
                                    <label for="tpSname" class="col-sm-2 control-label">站点名称</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="tpSname" class="form-control" id="tpSname"
                                               placeholder="站点名称">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <input type="text" name="tpSlocal" class="form-control" id="tpSlocal" placeholder="详细地址">
                                        </div>

                                        <label for="tpSlongitude" class="col-sm-1 control-label">经度</label>

                                        <div class="col-sm-1">
                                            <input type="text" name="tpSlongitude" class="form-control" id="tpSlongitude" placeholder="经度">
                                        </div>

                                        <label for="tpSlatitude" class="col-sm-1 control-label">纬度</label>

                                        <div class="col-sm-1">
                                            <input type="text" name="tpSlatitude" class="form-control" id="tpSlatitude" placeholder="纬度">
                                        </div>
