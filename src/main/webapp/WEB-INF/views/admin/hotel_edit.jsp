						...
						<form class="form-horizontal" action="/admin/hoteledithandle" method="post">
							<div class="box-body">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" name="local" value="${hotel.city}" class="form-control" id="city"
								...
								<%--详细地址--%>
									<div class="form-group">
										...
										<div class="col-sm-1">
											<input type="text" name="longitude" class="form-control" id="longitude" value="${hotel.longitude}" placeholder="${hotel.longitude}">
										</div>

										<label for="latitude" class="col-sm-1 control-label">纬度</label>

										<div class="col-sm-1">
											<input type="text" name="latitude" class="form-control" id="latitude" value="${hotel.latitude}" placeholder="${hotel.latitude}">
										</div>
