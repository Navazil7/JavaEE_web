							...
							<div class="box-body">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										...
										<input type="text" name="currentTime" value="<fmt:formatDate value="${CurrentTime}" pattern="yyyy-MM-dd HH:mm:ss"/>" class="form-control" id="currentTime"
											   placeholder="<fmt:formatDate value="${CurrentTime}" pattern="yyyy-MM-dd HH:mm:ss"/>">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										...
										<input type="text" name="arriveTime" value="<fmt:formatDate value="${ArriveTime}" pattern="yyyy-MM-dd HH:mm:ss"/>" class="form-control" id="arriveTime"
											   placeholder="<fmt:formatDate value="${ArriveTime}" pattern="yyyy-MM-dd HH:mm:ss"/>">
									</div>
								</div>
